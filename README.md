...
### Windows
- **[Instalador](https://github.com/elissoncoimbra/routini/releases/latest/download/Routini-Setup-0.1.0-alpha.1.exe)** - Versão completa com instalador
- **[Portátil](https://github.com/elissoncoimbra/routini/releases/latest/download/Routini-0.1.0-alpha.1-portable.exe)** - Executável standalone

### macOS
- **[DMG](https://github.com/elissoncoimbra/routini/releases/latest/download/Routini-0.1.0-alpha.1-arm64.dmg)** - Instalador para macOS
- **[ZIP](https://github.com/elissoncoimbra/routini/releases/latest/download/Routini-0.1.0-alpha.1-arm64-mac.zip)** - Versão compactada
